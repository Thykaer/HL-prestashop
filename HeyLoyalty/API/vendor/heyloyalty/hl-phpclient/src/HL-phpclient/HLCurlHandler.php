...
class HLCurlHandler
{
     ...
     * @return mixed
     */
    public function makeCall($requestType, $url, $postFields, $file, $signature, $date)
    {
        $headers = array(
     ...
     * @return mixed
     */
    public function setCall($requestType, $url, $postFields, $file, $signature, $date)
    {
        $headers = array(
            "authorization: Basic " . $signature . "",
            "x-request-timestamp: " . $date . "",
     ...
     * @return array
     */
    public function buildOneDimensionArray($arrays, &$new = array(), $prefix = null)
    {
        if (is_object($arrays)) {
