...
class HeyLoyalty extends Module
{
    ...
    protected function getHLCustomer($customerData, $orderData, $customer)
    {
        $member = [
            ...
            'average_products_per_order' => $orderData['average_quantity'],
            'total_products_ordered' => $orderData['total_products'],
            'spent_average' => Tools::convertPrice($orderData['average_spent']),
            'spent_total' => Tools::convertPrice($orderData['total_spent']),
            'spent_last_order' => Tools::convertPrice($orderData['spent_last_order']),
